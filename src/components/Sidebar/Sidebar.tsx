			...
			>
				...
				<div className="absolute  right-0 top-30">
					<div className="flex flex-col gap-y-[15vh] w-30">
						<div
							className={`border-1 text-center border-accent bg-accent hover:bg-accent-hover hover:drop-shadow-[0_0_2px_white] rounded-full p-2 cursor-pointer text-lg text-text ${
								onClickOpen ? "w-30" : "w-9"
							} duration-300`}
						>
							Fazendas
